def finalList(rank1, perc, category, university, gender, pwd, sortby, branch):
    ...
    # Filter based on selected category (e.g., SC)
    ...
    if perc:
        ...
        q['Probability'] = 100 * (1 - (rank - q['Rank']) / q['Rank'])
        # elif rank:
    ...
    # Drop duplicates based on college and branch
    x = q.drop_duplicates(subset=['Institute', 'Branch Name'])
